    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='confirmation_tokens', to=settings.AUTH_USER_MODEL, verbose_name='The user which is associated with this token')),
            ],
            options={
